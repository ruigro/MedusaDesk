...
import '../consts.dart';
import 'common/medusa_theme.dart';
import 'common/widgets/overlay.dart';

export 'common/medusa_theme.dart';
...
Widget loadLogo() {
  return FutureBuilder<ByteData>(
      future: rootBundle.load('assets/medusa_logo.png'),
      builder: (BuildContext context, AsyncSnapshot<ByteData> snapshot) {
        if (snapshot.hasData) {
          final textColor = Theme.of(context).textTheme.titleLarge?.color;
          final image = Image.asset(
            'assets/medusa_logo.png',
            fit: BoxFit.contain,
          ...
          return Container(
            ...
            child: Column(
              mainAxisSize: MainAxisSize.min,
              children: [
                SizedBox(width: 74, height: 74, child: image),
                SizedBox(height: 8),
                Text(
                  'MEDUSA DESK',
                  textAlign: TextAlign.center,
          ...
          ).marginOnly(left: 12, right: 12, top: 14, bottom: 8);
        }
