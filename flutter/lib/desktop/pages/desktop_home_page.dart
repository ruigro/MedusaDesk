...
class _DesktopHomePageState extends State<DesktopHomePage>
  ...
  BoxDecoration _medusaPanel(BuildContext context,
    ...
    return BoxDecoration(
      ...
      color: isDark
          ? (hero ? null : MedusaColors.surface)
          : MedusaColors.lightSurface,
      borderRadius: BorderRadius.circular(16),
      border: Border.all(
          color: isDark ? MedusaColors.hairline : MedusaColors.lightHairline),
      boxShadow: isDark ? MedusaColors.glow(glowColor) : null,
    );
  }
  ...
  buildIDBoard(BuildContext context) {
    ...
    return Container(
      ...
      decoration: _medusaPanel(context, hero: true),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Row(
                ...
                child: GestureDetector(
                  ...
                  child: TextFormField(
                    ...
                    style: TextStyle(
                      ...
                      letterSpacing: 0.8,
                      color: isDark
                          ? MedusaColors.biolume
                          : MedusaColors.biolumeDim,
                    ),
  ...
  buildPasswordBoard2(BuildContext context, ServerModel model) {
    ...
    final textColor = Theme.of(context).textTheme.titleLarge?.color;
    final isDark = Theme.of(context).brightness == Brightness.dark;
    final mutedIcon = isDark ? MedusaColors.textMuted : Color(0xFFBBBBBB);
                ...
                child: GestureDetector(
                  ...
                  child: TextFormField(
                    ...
                    style: TextStyle(
                      fontSize: 16,
                      letterSpacing: 1.0,
                      color: isDark ? MedusaColors.violet : null,
                    ),
                  ).workaroundFreezeLinuxMint(),
                ),
              ),
                ...
                AnimatedRotationWidget(
                  ...
                  child: Tooltip(
                    ...
                    child: Obx(() => RotatedBox(
                        ...
                        child: Icon(
                          Icons.refresh,
                          color: refreshHover.value ? textColor : mutedIcon,
                          size: 20,
                        ))),
                  ),
                ...
                InkWell(
                  child: Tooltip(
                    ...
                    child: Obx(
                      () => Icon(
                        Icons.edit,
                        color: editHover.value ? textColor : mutedIcon,
                        size: 20,
                      ).marginOnly(right: 8),
                    ),
                  ),
  ...
  buildTip(BuildContext context) {
    ...
    return Padding(
      padding:
          const EdgeInsets.only(left: 24.0, right: 18, top: 12.0, bottom: 5),
      child: Column(
        ...
        Container(
          ...
          child: Container(
              decoration: BoxDecoration(
                gradient: MedusaColors.installCardGradient,
                borderRadius: BorderRadius.circular(12),
                border: Border.all(color: MedusaColors.hairline),
              ),
