...
class TabbarTheme extends ThemeExtension<TabbarTheme> {
  ...
  static const dark = TabbarTheme(
      ...
      unSelectedTextColor: MedusaColors.textMuted,
      selectedIconColor: MedusaColors.textPrimary,
      unSelectedIconColor: MedusaColors.textMuted,
      dividerColor: MedusaColors.hairline,
      hoverColor: MedusaColors.surfaceHi,
      closeHoverColor: Colors.black26,
      selectedTabBackgroundColor: MedusaColors.biolumeFaint);
