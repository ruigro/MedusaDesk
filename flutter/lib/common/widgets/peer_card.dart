      ...
      children: [
        Container(
            decoration: BoxDecoration(
              // Blend the per-peer hue over the Medusa surface so random
              // colors stay within the abyss palette.
              color: Color.alphaBlend(
                  str2color('${peer.id}${peer.platform}', 0x66),
                  Theme.of(context).brightness == Brightness.dark
                      ? MedusaColors.surfaceHi
                      : MedusaColors.lightHover),
